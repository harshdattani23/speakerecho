...
import { TranscriptionSegment, Emotion, RealTimeTranscription } from "../types";
...
export const connectToLiveTranscription = async (
  onMessage: (message: RealTimeTranscription) => void,
  ...
  const session = await ai.live.connect({
    ...
    config: {
      ...
      systemInstruction: "You are a real-time transcription assistant. Transcribe the user's speech accurately. Do not respond with your own words, only provide the transcription of what you hear.",
      speechConfig: {
    ...
    callbacks: {
      onmessage: (message: LiveServerMessage) => {
        // Check for model turn parts (standard way)
